...
public class PopularCategoriesAdapter extends  RecyclerView.Adapter<PopularCategoriesAdapter.CategoriesHolder> {
    ...
    public PopularCategoriesAdapter(Context context, List<Category> categories) {
    ...
    public CategoriesHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.single_popular_category_layout, parent, false);
